...
class PasswordResteNewPasswordScreen extends StatefulWidget {
  const PasswordResteNewPasswordScreen({Key? key}) : super(key: key);

  @override
  State<PasswordResteNewPasswordScreen> createState() =>
      PasswordResteNewPasswordScreenState();
}

class PasswordResteNewPasswordScreenState
    extends State<PasswordResteNewPasswordScreen> {
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: PasswordResetButton(
                      formkey: _formKey, route: () {}, text: "Set My Password"),
                )
              ],
            ),
          ),
