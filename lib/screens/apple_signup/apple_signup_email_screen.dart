...
class AppleSignUpEmailScreen extends StatefulWidget {
  AppleSignUpEmailScreen({Key? key}) : super(key: key);

  @override
  State<AppleSignUpEmailScreen> createState() => _AppleSignUpEmailScreenState();
}

class _AppleSignUpEmailScreenState extends State<AppleSignUpEmailScreen> {
  final TextEditingController appleEmailController = TextEditingController();
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Align(
                    alignment: Alignment.topLeft,
                    child: Text("What is your Apple ID Email Address?")),
                customTextformfield(
                  thisController: appleEmailController,
                  hint: "Email address",
                ),
                whitespace(context, 2.3, 0),
                SizedBox(
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        appleSignUpController
                            .getAppleEmail(appleEmailController.text);
                        Get.to(() => AppleSignupUsernameScreen());
                      }
                    },
                    child: Text("Next"),
                  ),
